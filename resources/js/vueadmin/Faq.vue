<template>
    <div>
        ...
        <div>
            <!--Start sección de manuales (importación)-->
            ...
            <br>
        <!--End sección de manuales (importación)-->
            <!--Start sección de manuales (tabla)-->
            <div class="card-container">
                <div class="card">
            ...
            <!-- Start sección de manuales (Modal Editar Manual) -->
